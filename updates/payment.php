...
<br>Enter Card Owner Name:<input type="text" name="nm"><br>
...
<br>
Enter CVV:<input type="int" name="ta" pattern="[0-9]{3}"><br>
<input type="submit">
<br>
...
$a=$_POST['at'];
	...
	//mysqli_query($conn,"create table payment(name varchar(20),ptir varchar(20),amtr int)") or die(mysqli_error($conn));
    $value="INSERT INTO payment(name,ptir,amtr) VALUES('$n','$c','$a')";
  $conn->query($value);
  if(mysqli_query($conn,$value)===TRUE)
  {
	$message = "payment successful your payment id is \"1234\"";
