...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
  ...
  $dbname="sms";
   ...
   $password = "";
    ...
    //$table1="CREATE TABLE student(name varchar(20),  primary key AUTO_INCREMENT,c_name VARCHAR(20),c_email VARCHAR(50),c_pass VARCHAR(20),c_address VARCHAR(50),c_mno BIGINT)";
   // $conn->query($table1);
    if($pass==$pass0)
    {
		if($sele=="student"){
