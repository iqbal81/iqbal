...
<option>PRACTICAL</option></select></th>
<th><select name="ss">
<option>JAVA</option>
<option>PHP</option>
<option>TCS</option>
...
<option>MINI PROJECT</option>
<option>PRACTICAL</option></select></th>
<th><select name="ss"><option>JAVA</option><option>PHP</option><option>TCS</option><option>MINI PROJECT</option><option>PRACTICAL</option></select></th>
<th><select name="ss">
<option>JAVA</option>
<option>PHP</option>
<option>TCS</option>
