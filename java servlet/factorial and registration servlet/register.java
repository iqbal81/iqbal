...
public class register extends GenericServlet
{
	public void doGet(ServletRequest req,ServletResponse res) throws IOException, ServletException
	{
		...
		try
		{
			...
			Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3308/registration","root","1111");
			PreparedStatement st=con.prepareStatement("insert into re values(?,?,?,?,?)");
